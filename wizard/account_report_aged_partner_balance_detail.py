...
class account_aged_trial_balance_detail(osv.osv_memory):
    _inherit = 'account.common.partner.report'
    _name = 'account.aged.trial.balance.detail'
    _description = 'Account Aged Trial balance detail Report'
    ...
    _columns = {
        ...
        'journal_ids': fields.many2many('account.journal', 'account_aged_trial_balance_detail_journal_rel', 'account_id', 'journal_id', 'Journals', required=True),
    }
    _defaults = {
        'period_length': 30,
    ...
    def _print_report(self, cr, uid, ids, data, context=None):
        ...
        return self.pool['report'].get_action(cr, uid, [], 'report_aged_partner_balance_detail.report_agedpartnerbalancedetail', data=data, context=context)
...
class report_agedpartnerbalancedetail(osv.AbstractModel):
    _name = 'report.report_aged_partner_balance_detail.report_agedpartnerbalancedetail'
    _inherit = 'report.abstract_report'
    _template = 'report_aged_partner_balance_detail.report_agedpartnerbalancedetail'
